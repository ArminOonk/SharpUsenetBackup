...
{
	[TestFixture()]
	public class TestIncrementalCRC
	{
		[Test]
		public void BuiltInHash()
		{
			//test a built in hash to make sure our testing technique is sound
			SHA256Managed a1 = new SHA256Managed();
			SHA256Managed a2 = new SHA256Managed();
